  ...
  function Rr(i) {
    ...
    i.valid_elements
      ...
      : (xr(n, function(e, t) {
        ...
        xr(kr('p h1 h2 h3 h4 h5 h6 th td pre div address caption li'), function(
          e,
        ) {
          x[e].paddEmpty = !0;
        }),
  ...
  var Rb = function(o, i, a, e, u, t) {
    ...
    lC = function(e, t, n) {
      ...
      return ((a = u).breakType === ry.Wrap && 0 === a.positions.length) ||
        (!Rn(n.getNode()) &&
          (i = u).breakType === ry.Br && 1 === i.positions.length)
        ? ((r = e),
          (o = t),
          !u.breakAt
            .map(function(e) {
      ...
      return Bu(t, n, OC).filter(function(e) {
        return (
          ...
          Mt((n = e).from.block)
            ...
            .isSome() &&
          !1 === Dn((t = e).from.block.dom()) && !1 === Dn(t.to.block.dom())
        );
        var t, n, r;
      });
    },
